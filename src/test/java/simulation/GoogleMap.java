...
public class GoogleMap {
	...
	public void setup() throws MalformedURLException {
		...
		//caps.setCapability("optionalIntentArguments", "-d geo:3d12.9555992,4d77.7150136");
...
//!
	...
	/*
	 * locus: the center of the touch gesture, the point that fingers are pinching
	 * away from or towards. They won't actually touch this point though
	 * startRadius: distance from center that fingers begin at endRadius: distance
	 * from center that fingers end at pinchAngle: at what angle the fingers pinch
	 * around the locus, in degrees. 0 for vertical pinch, 90 for horizontal pinch
	...
	private Sequence zoomSinglefinger(String fingerName, Point locus, int startRadius, int endRadius, double angle,
			Duration duration) {
	...
	/*
	 * Simplified method for zooming in. Defaults to a 45 degree angle for the pinch
	 * gesture. Defaults to a duration of half a second Fingers start 50px from
	 * locus
	 * 
	 * locus: the center of the pinch action, fingers move away from here distance:
	 * how far fingers move outwards, starting 100px from the locus
	 */
	...
	/*
	 * Simplified method for zooming out. Defaults to a 45 degree angle for the
	 * pinch gesture. Defaults to a duration of half a second Fingers finish 50px
	 * from locus
	 * 
	 * locus: the center of the pinch action, fingers move towards here distance:
	 * how far fingers move inwards, they will end 100px from the locus
	 */
